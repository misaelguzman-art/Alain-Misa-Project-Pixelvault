...
-- ============================================================
-- 6. CORRECCIÓN DEL TRIGGER DE MOVIMIENTO DE INVENTARIO
-- ============================================================
IF OBJECT_ID('Product.trg_MovimientoInventario', 'TR') IS NOT NULL
    DROP TRIGGER Product.trg_MovimientoInventario;
GO
